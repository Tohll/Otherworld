class_name AbsCharacter extends CharacterBody2D

const DAMAGE_INDICATOR = preload("res://prototypes/scenes/objects/damage_indicator.tscn")
const BLOOD_EFFECT = preload("res://prototypes/scenes/objects/blood_effects.tscn")
const DEATH_EFFECT = preload("res://prototypes/scenes/objects/death_particles.tscn")
